...
struct sound_dev {				// data for sound capture or playback device
	...
	int started;				// DirectX: started flag
...
int quisk_process_microphone(int, complex *, int);
...
void quisk_tmp_microphone(complex *, int);
...
#define QUISK_API_INIT	{ \
 ...
 &QuiskSleepMicrosec, &QuiskPrintTime, &quisk_sample_source \
 }
